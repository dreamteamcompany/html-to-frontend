                ...
                >
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '6px', alignItems: 'flex-start', gap: '8px' }}>
                    <div style={{ minWidth: 0, flex: 1 }}>
                      {item.service_name && (
                        <div style={{ fontSize: '13px', fontWeight: 600, color: 'hsl(var(--foreground))', marginBottom: '2px', overflowWrap: 'anywhere', lineHeight: 1.3 }}>{item.service_name}</div>
                      )}
                      {item.description && (
                        <div style={{ fontSize: '12px', color: 'hsl(var(--muted-foreground))', overflowWrap: 'anywhere', lineHeight: 1.3 }}>{item.description}</div>
                      )}
                    </div>
            ...
            <div>
              {sorted.map((item, idx) => (
                ...
                >
                  ...
                  {/* Описание */}
                  <div style={{ fontSize: '12px', color: 'hsl(var(--muted-foreground))', overflowWrap: 'anywhere', minWidth: 0, lineHeight: 1.3 }}>
