...
const AnnualSavingsKPICard = () => {
  ...
  return (
    <>
    <Card
      style={{ background: 'hsl(var(--card))', border: '1px solid rgba(1, 181, 116, 0.3)', borderTop: '4px solid #7551e9', boxShadow: '0 4px 28px rgba(117,81,233,0.13)', position: 'relative', overflow: 'hidden', cursor: loading ? 'default' : 'pointer' }}
